...
(function($) {
	...
	function UbicarIdioma() {
		$("#divIdioma").removeClass();
		if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) 
			|| $(window).width() <= 823) {
			$("#divIdioma").addClass("divIdiomaMobile");
			$("#divIdiomaMobile").html($("#divIdioma"));
		} else {
			$("#divIdioma").addClass("divIdiomaWeb");
			$("#divIdiomaWeb").html($("#divIdioma"));
		}
	}
